...
export const listConsumerProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('/api/products/consumer')
...
export const listConsumerProductsDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/products/consumer/${id}`)
...
export const deleteConsumerProduct = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`/api/products/consumer/${id}`, config)
...
export const createConsumer = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`/api/products/consumer`, {}, config)
...
export const updateConsumer = (consumer) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`/api/products/consumer/${consumer._id}`, consumer, config)
