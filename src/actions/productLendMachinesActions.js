...
export const listLendMachineProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('/api/products/lendMachines')
...
export const listLendMachineProductsDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/products/lendMachines/${id}`)
...
export const deleteLendMachineProduct = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`/api/products/lendMachines/${id}`, config)
...
export const createLendMachine = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`/api/products/lendMachines`, {}, config)
...
export const updateLendMachine = (machine) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`/api/products/lendMachines/${machine._id}`, machine, config)
