...
export const listSeedProducts = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('/api/products/seeds')
...
export const listSeedProductsDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/products/seeds/${id}`)
...
export const deleteSeedProducts = (id) => async (dispatch, getState) => {
    try {
        ...
        await axios.delete(`/api/products/seeds/${id}`, config)
...
export const createSeedProducts = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`/api/products/seeds`, {}, config)
...
export const updateSeedProducts = (seed) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`/api/products/seeds/${seed._id}`, seed, config)
...
export const createProductReview = (productId, review) => async (
    ...
    try {
      ...
      await axios.post(`/api/products/seeds/${productId}/reviews`, review, config)
